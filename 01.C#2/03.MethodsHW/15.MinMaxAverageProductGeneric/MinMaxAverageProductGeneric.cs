...
class MinMaxAverageProductGeneric
{
    ...
    {
        decimal min = Min(6.1m, 3.11111m, 2.543m);
        decimal max = Max(6.1m, 3.11111m, 2.543m);
        decimal sum = Sum(6.1m, 3.11111m, 2.543m);
        decimal average = Average(6.1m, 3.11111m, 2.543m);
        decimal product = Product(6.1m, 3.11111m, 2.543m);
