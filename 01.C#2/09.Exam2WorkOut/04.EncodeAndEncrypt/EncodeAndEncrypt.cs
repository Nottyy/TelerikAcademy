...
class EncodeAndEncrypt
{
    ...
    private static char EncryptSymbol(char messageSymbol, char cypherSymbol)
    {
        ...
        int cypherSymbolCodde = cypherSymbol - 'A';
        int xoredSymbols = messageSymbolCode ^ cypherSymbolCodde;
        char encrypted = (char)(xoredSymbols + 'A');
    ...
    static string Encode(string text)
    {
        ...
        {
            result.Append(previousSymbol.ToString() + previousSymbol.ToString());
        }
        else
        {
            result.Append(counter + previousSymbol.ToString());
