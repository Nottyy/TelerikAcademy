...
namespace SoftwareAcademy
{
    ...
    public class Teacher : ITeacher
    {
        ...
        public string Name
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException("Teacher cannot be null or whitespaced");
                }
                this.name = value;
            }
        }
    ...
    public class LocalCourse : Course, ILocalCourse
    {
        ...
        public string Lab
        {
            ...
            set
            {
                if (string.IsNullOrWhiteSpace(value))
                {
                    throw new ArgumentOutOfRangeException("Lab cannot be null or whitespaced");
                }
                this.lab = value;   
            }
        }
    ...
    public class OffsiteCourse : Course, IOffsiteCourse
    {
        ...
        public string Town
        {
            ...
            set
            {
                if (string.IsNullOrWhiteSpace(value))
                {
                    throw new ArgumentOutOfRangeException("Town cannot be null or whitespaced");
                }
                this.town = value;
            }
        }
    ...
    public abstract class Course : ICourse
    {
        ...
        public override string ToString()
        {
            ...
            output.AppendFormat("{0}: Name={1}", GetType().Name, this.Name);
