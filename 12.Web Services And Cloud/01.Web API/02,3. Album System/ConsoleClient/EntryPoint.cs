...
using AlbumSystem.Services.Models;
    ...
    {
        const string serviceRoot = "http://localhost:1365/";
        ...
        {
            var response = httpClient.GetAsync("album").Result;
        ...
        static void AddAlbum(HttpClient httpClient, Album theAlbum)
        {
            ...
            var response = httpClient.PostAsync("album", postContent).Result;
            try
            {
        ...
        private static void UpdateAlbumName(HttpClient httpClient, int albumId, string newName)
        {
            ...
            var response = httpClient.PutAsJsonAsync("album/id/" + albumId, newName).Result;
        ...
        {
            var response = httpClient.DeleteAsync("album/id/" + albumId).Result;
